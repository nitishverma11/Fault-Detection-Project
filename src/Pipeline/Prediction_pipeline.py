...
class PredicitionPipeline:
    ...
    def get_predicted_dataframe(self,input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            predicition_column_name : str = TARGET_COLUMN
            ...
            input_dataframe[predicition_column_name] = [pred for  pred in predicitions]

            target_column_mapping = {0:'bad',1:'good'}

            input_dataframe[predicition_column_name] = input_dataframe[predicition_column_name].map(target_column_mapping)
